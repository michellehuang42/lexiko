...
db = client.test
mayo_diseases = db.mayo_diseases
# result = '['

# opening up connection, grabs page
my_url = 'https://www.mayoclinic.org/diseases-conditions/index?letter=A'
...
groups = page_soup.findAll("div", {"class": "index"})
...
for group in groups:
		...
		for topic in topics:
			...
			disease_url = "https://www.mayoclinic.org" + topic['href']
			...
			new_soup = dis_soup.find("div", {"class":"content"})
